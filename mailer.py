...
# developer info
Label(root,text = "Developer: Debayan Chakraborty").grid(column=0,row=20)
Label(root,text = "Instagram: deba.dc99").grid(column=0,row=21)
Label(root,text = "LinkedIn: Debayan Chakraborty").grid(column=0,row=22)
